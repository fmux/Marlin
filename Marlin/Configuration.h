...
#define STRING_CONFIG_H_AUTHOR "(fmux, default config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 2, 25 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 }
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -95  // Y offset: -front +behind [the nozzle]
